function initialize() { 
	...
	var shadow = {
		url: '../images/map_markers/ics_shadow.png',
	...
	setTimeout(function(){ polyline1.setMap(map); }, 1000);
	setTimeout(function(){ polyline2.setMap(map); }, 1100);
	setTimeout(function(){ polyline3.setMap(map); }, 1200);
	setTimeout(function(){ polyline4.setMap(map); }, 1300);
	setTimeout(function(){ polyline5.setMap(map); }, 1400);
	setTimeout(function(){ polyline6.setMap(map); }, 1500);
	setTimeout(function(){ polyline7.setMap(map); }, 1600);
	setTimeout(function(){ polyline8.setMap(map); }, 1700);
	setTimeout(function(){ polyline9.setMap(map); }, 1800);
	setTimeout(function(){ polyline10.setMap(map); }, 1900);
	setTimeout(function(){ polyline11.setMap(map); }, 2000);
	setTimeout(function(){ polyline12.setMap(map); }, 2100);
	setTimeout(function(){ polyline13.setMap(map); }, 2200);
	setTimeout(function(){ polyline14.setMap(map); }, 2300);
	setTimeout(function(){ polyline15.setMap(map); }, 2400);
	setTimeout(function(){ polyline16.setMap(map); }, 2500);
	setTimeout(function(){ polyline17.setMap(map); }, 2600);
	setTimeout(function(){ polyline18.setMap(map); }, 2700);
	setTimeout(function(){ polyline19.setMap(map); }, 2800);
	setTimeout(function(){ polyline20.setMap(map); }, 2900);
	setTimeout(function(){ polyline21.setMap(map); }, 3000);
	setTimeout(function(){ polyline22.setMap(map); }, 3100);
	setTimeout(function(){ polyline23.setMap(map); }, 3200);
	setTimeout(function(){ polyline24.setMap(map); }, 3300);
	setTimeout(function(){ polyline25.setMap(map); }, 3400);
	setTimeout(function(){ polyline26.setMap(map); }, 3500);
	setTimeout(function(){ polyline27.setMap(map); }, 3600);
	setTimeout(function(){ polyline28.setMap(map); }, 3700);
	setTimeout(function(){ polyline29.setMap(map); bgline.setMap(null);}, 3800);
...
function resetMe(controlDiv, map) {
	...
	controlUI.title = 'Reset to Owens Lake';
	controlDiv.appendChild(controlUI);
  	...
  	controlText.innerHTML = '<strong>Go back to Owens Lake</strong>';
